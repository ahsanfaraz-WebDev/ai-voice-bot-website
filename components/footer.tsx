                ...
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link.name}>
                      <a 
                        href={link.href}
                        className="text-white/60 hover:text-purple-200 transition-colors duration-300 text-sm"
                      >
                        {link.name}
                      </a>
                    </li>
        ...
        <div ref={socialRef} className="bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl border border-white/10 rounded-2xl p-8 mb-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex gap-3">
              ...
              />
              <button className="bg-white text-gray-900 hover:bg-gray-100 font-medium px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 whitespace-nowrap shadow-md">
                Subscribe
              </button>
            </div>
          </div>
